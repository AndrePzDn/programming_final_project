...
public class Movie4 extends javax.swing.JDialog {


    public Movie4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TitleMovie.setText("SPIDERMAN Sin Camino a Casa");
        ...
        Image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pelicula (4).jpg"))); // NOI18N
