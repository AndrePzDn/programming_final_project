...
public class Movie5 extends javax.swing.JDialog {


    public Movie5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pelicula (5).jpg"))); // NOI18N
